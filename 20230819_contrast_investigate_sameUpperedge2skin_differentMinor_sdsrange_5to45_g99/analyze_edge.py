...
outputPath = "/media/md703/Expansion/syu/ijv_2_output/20230819_contrast_investigate_sameUpperedge2skin_differentMinor_sdsrange_5to45_g99"
...
ax[0].plot(targetSdsSet, contrastAll['minor_-3.5_mm']-1, label="Minor axis: 2 mm")
ax[0].plot(baselinedf["SDS [mm]"][sdsObservedRange[0]: sdsObservedRange[1]], 
         ...
         label="Minor axis: 5.5 mm (Average)")
ax[0].plot(targetSdsSet, contrastAll['minor_+3.5_mm']-1, label="Minor axis: 9 mm")
...
plt.suptitle("Fixed Distance of IJV upper edge to skin surface", x=0.55, y=0.93)
plt.tight_layout()
plt.show()

plt.plot(targetSdsSet, utils.normalize(contrastAll['minor_-3.5_mm']-1), label="Semi-minor axis: 2 mm")
plt.plot(baselinedf["SDS [mm]"][sdsObservedRange[0]: sdsObservedRange[1]], 
         utils.normalize(baselinedf["Rmax/Rmin [-]"][sdsObservedRange[0]: sdsObservedRange[1]]-1), 
         label="Semi-minor axis: 5.5 mm\n(Average)")
plt.plot(targetSdsSet, utils.normalize(contrastAll['minor_+3.5_mm']-1), label="Semi-minor axis: 9 mm")
