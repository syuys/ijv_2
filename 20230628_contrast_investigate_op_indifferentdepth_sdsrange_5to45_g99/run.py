...
# parameter
projectID = "20230628_contrast_investigate_op_indifferentdepth_sdsrange_5to45_g99"
# sessionIDSet = [i.split("/")[-1] for i in glob(os.path.join("ijv*"))]
sessionIDSet = [
                # "ijv_dis_depth_-1_std_skin_0%_fat_0%_muscle_0%_blood_0%",  
                # "ijv_col_depth_-1_std_skin_0%_fat_0%_muscle_0%_blood_0%", 
                # "ijv_dis_depth_-1_std_skin_100%_fat_100%_muscle_100%_blood_100%",  
                # "ijv_col_depth_-1_std_skin_100%_fat_100%_muscle_100%_blood_100%", 
                # "ijv_dis_depth_+1_std_skin_0%_fat_0%_muscle_0%_blood_0%",  
                # "ijv_col_depth_+1_std_skin_0%_fat_0%_muscle_0%_blood_0%", 
                "ijv_dis_depth_+1_std_skin_100%_fat_100%_muscle_100%_blood_100%",  
                "ijv_col_depth_+1_std_skin_100%_fat_100%_muscle_100%_blood_100%", 
