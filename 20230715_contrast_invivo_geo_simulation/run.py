...
# parameter
projectID = "20230715_contrast_invivo_geo_simulation"
# sessionIDSet = [i.split("/")[-1] for i in glob(os.path.join("ijv*"))]
sessionIDSet = [
                "ijv_dis_HY_anotherPerturbed_skin_0%_fat_0%_muscle_0%_blood_0%",
                "ijv_col_HY_anotherPerturbed_skin_0%_fat_0%_muscle_0%_blood_0%", 
                "ijv_dis_HY_anotherPerturbed_skin_50%_fat_50%_muscle_50%_blood_50%",
                "ijv_col_HY_anotherPerturbed_skin_50%_fat_50%_muscle_50%_blood_50%", 
                "ijv_dis_HY_anotherPerturbed_skin_100%_fat_100%_muscle_100%_blood_100%",
                "ijv_col_HY_anotherPerturbed_skin_100%_fat_100%_muscle_100%_blood_100%", 
                
                "ijv_dis_BY_skin_0%_fat_0%_muscle_0%_blood_0%",
                "ijv_col_BY_skin_0%_fat_0%_muscle_0%_blood_0%", 
                "ijv_dis_BY_skin_50%_fat_50%_muscle_50%_blood_50%",
                "ijv_col_BY_skin_50%_fat_50%_muscle_50%_blood_50%", 
                "ijv_dis_BY_skin_100%_fat_100%_muscle_100%_blood_100%",
                "ijv_col_BY_skin_100%_fat_100%_muscle_100%_blood_100%", 
                
                # "ijv_dis_EU_skin_0%_fat_0%_muscle_0%_blood_0%",
                # "ijv_col_EU_skin_0%_fat_0%_muscle_0%_blood_0%", 
                # "ijv_dis_EU_skin_50%_fat_50%_muscle_50%_blood_50%",
                # "ijv_col_EU_skin_50%_fat_50%_muscle_50%_blood_50%", 
                # "ijv_dis_EU_skin_100%_fat_100%_muscle_100%_blood_100%",
                # "ijv_col_EU_skin_100%_fat_100%_muscle_100%_blood_100%", 
                ]
gpuIdx = 2
