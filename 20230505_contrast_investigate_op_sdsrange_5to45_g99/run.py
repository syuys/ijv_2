...
# parameter
projectID = "20230505_contrast_investigate_op_sdsrange_5to45_g99"
sessionIDSet = [i.split("/")[-1] for i in glob(os.path.join("ijv*"))]
# sessionIDSet = [
#                 # "ijv_dis_skin_100%_fat_100%_muscle_100%_blood_100%",  
#                 # "ijv_col_skin_100%_fat_100%_muscle_100%_blood_100%",
#                 "ijv_dis_skin_0%_fat_0%_muscle_0%_blood_0%",
#                 # "ijv_col_skin_0%_fat_0%_muscle_0%_blood_0%",
#                 ]
gpuIdx = 2
